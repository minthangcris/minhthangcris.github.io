  ...
  form.onsubmit = (e) => {
    ...
    if (passInput.value.trim() === "") {
      ...
      passField.classList.add("error");
      passField.querySelector(".error-txt").innerText = "Password must be at least 6 characters";
      valid = false;
    } else {
    ...
    if (cpassInput.value.trim() === "") {
      ...
      cpassField.querySelector(".error-txt").innerText = "Please confirm your password";
      valid = false;
